...
import type { AuditLog, Case, DetectedDevice, Device } from "../api/types";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    return subscribe((ev) => {
      if (["device_hotplug", "audit_logged", "scan_completed"].includes(ev.type)) {
        detect();
        reload();
      }
    });
  ...
  return (
    <div>
      ...
      <p className="page-sub">
        Төхөөрөмж илрүүлэх, бүх файл/устгагдсан файл шинжлэх, залгах-салгах болон бүх үйлдлийн log.
      </p>
      ...
      <div className="panel">
        <h2>Үйлдлийн log (залгах / салгах / шинжилгээ)</h2>
                ...
                <td>
                  <div className="row-flex">
                    ...
                    <button
                      ...
                      onClick={() => startScan(d)}
                      title="TSK + ntfsundelete — төхөөрөмж дээр шууд"
                    >
                      {busy === `scan-${d.id}` ? "Шинжилж байна…" : "Шинжилгээ эхлүүлэх"}
                    </button>
                  </div>
                </td>
              </tr>
